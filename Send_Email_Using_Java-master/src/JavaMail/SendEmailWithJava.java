...
public class SendEmailWithJava {
    ...
    // Data Fields.
    private static final String EMAIL_TO = "reciver@gmail.com";
    private static final String EMAIL_SUBJECT = "Email testing java program";
    private static final String EMAIL_TEXT = "Email recieved sucessfully !!";
    private static final String EMAIL_FROM = "sender@gmail.com";
